...
CREATE TABLE MEDIA    
 ...
 CREATE TABLE RESULT_TYPE    
   ...
   (
	   ...
	   WINNER_ID INT, 
	   RUNNER_ID INT ,
	   SCHEDULE_LOGIC_ID INT DEFAULT 1 NOT NULL,
	  GAME_TYPE_ID  INT DEFAULT 1 NOT NULL ,
	  START_DATE DATETIME,
	  END_DATE DATETIME ,
	  MATCH_INTERVAL_DAYS INT DEFAULT 7 NOT NULL ,
	  DIVISION DECIMAL(5,2) NOT NULL,
	  MEDIA_ID INT,
	   CONSTRAINT TOURNAMENT_PK PRIMARY KEY (TOURNAMENT_ID),
	   CONSTRAINT TOURNAMENT_DIVISION_UK UNIQUE (DIVISION),
